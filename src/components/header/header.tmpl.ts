export default `<header data-id="{{_id}}" class="header">
<div class="header__info">
    ...
    <div class="actions__wrapper">
          ...
          <li class="actions__item"> 
            <button onclick="chat.modal.openModal('box-modal-add-user')"> 
          ...
          <li class="actions__item">
              <button onclick="chat.modal.openModal('box-modal-remove-user')">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="11" cy="11" r="10.25" stroke="#3369F3" stroke-width="1.5"/>
              ...
              Удалить пользователя
                    ...
                    <li class="actions__item">
              <button onclick="chat.modal.openModal('box-modal-remove-chat')">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="11" cy="11" r="10.25" stroke="#3369F3" stroke-width="1.5"/>
                    <line x1="7.1109" y1="7.11103" x2="14.8891" y2="14.8892" stroke="#3369F3" stroke-width="1.5"/>
                    <line x1="7.11078" y1="14.8891" x2="14.889" y2="7.11093" stroke="#3369F3" stroke-width="1.5"/>
